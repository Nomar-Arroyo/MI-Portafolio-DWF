// src/data/asignaciones.js
export const asignacionesData = [
  {
    id: 1,
    tag: "Asignación 01",
    title: "Introducción a JavaScript",
    description: "Lógica básica, interacción con el DOM, variables y estructuras de control iniciales aplicadas con Vanilla JS.",
    path: "./Asignacion-01/index.html"
  },
  {
    id: 2,
    tag: "Asignación 02",
