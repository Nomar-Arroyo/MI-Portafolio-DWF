...
- Si el archivo contiene palabras clave específicas como `fiesta`, `cumple`, `amigos`, `party`, `birthday`, `viaje`, `boda` o `graduacion`, el objeto se clasifica automáticamente con la bandera `isMoment: true`.
